      ...
      <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      PYG {convertUsdToPyg(billing.currentBalance || 0).toLocaleString('es-PY')}
                    </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      PYG {convertUsdToPyg(billing.totalPaid || 0).toLocaleString('es-PY')}
                    </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      PYG {convertUsdToPyg(billing.pendingPayments || 0).toLocaleString('es-PY')}
                    </p>
                          ...
                          <div>
                            ...
                            {invoice.sifenCDC && (
                              <div className="flex items-center gap-1 mt-1">
                                <Badge variant="outline" className="text-[10px] h-4 bg-green-50 text-green-700 border-green-200 py-0 px-1">
                                  ✓ e-Kuatia
                                </Badge>
                              </div>
                            )}
        ...
        {showPaymentModal && paymentInvoice && (
          <PaymentOptionsModal
            ...
            stageName={paymentInvoice.invoiceNumber || `Factura #${paymentInvoice.id}`}
            stageId={paymentInvoice.id}
            projectName={paymentInvoice.projectName || "General"}
            isInvoice={true}
          />
        )}
