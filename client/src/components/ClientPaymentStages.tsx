...
export const PaymentOptionsModal = ({ isOpen, onClose, amount, stageName, stageId, projectName, isInvoice }: PaymentOptionsModalProps) => {
  ...
  const handleSendProof = async () => {
    ...
    try {
      ...
      formData.append('paymentMethod', selectedMethodData.value);
      formData.append('paymentMethodId', selectedMethodData.id);
      ...
      if (response.ok) {
        // En lugar de usar result, usamos la data que tenemos del formulario para asegurar consistencia
        const actualMethodName = selectedMethodData.name;
          ...
          <div class="bg-white rounded-lg p-8 max-w-md w-full mx-4 text-center shadow-2xl">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-6 text-left">
              ...
              <div class="space-y-2 text-sm text-green-700">
                ...
                <p><strong>Método:</strong> ${actualMethodName}</p>
